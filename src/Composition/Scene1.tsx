  ...
  return (
    <AbsoluteFill>
      ...
      >
        ...
        <AbsoluteFill style={{ width: WIDTH * 0.11, right: '20%', top: 100, left: 'auto' }}>
          <GradientOverlay direction="topToBottom" height={HEIGHT} opacity={0.3} rate={0.65} delay={16} gradient={true} />
        </AbsoluteFill>
